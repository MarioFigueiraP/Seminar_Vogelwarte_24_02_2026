...
There are several extensions of the standard areal model that are less well known and less widely used. One crucial component in defining a (P)CAR model is the **adjacency matrix**. Instead of assigning equal weights to all neighboring areas, it is possible to introduce more flexible specifications for the weights.
